<x-master>
    <div class="col-md-11" id="sidebar-right-section">
        ...
        <div class="add-new-category mb-1  " style="display:flex;">
            ...
            <x-common.button tag='a' url="{{ route('Color.Create') }}" icon="fa-solid fa-plus" name="Add">
            </x-common.button>
        </div>
                ...
                <tbody>
                    @forelse ($colorList as $color)
                        <tr>
                            ...
                            <td>{{ $color->color }}</td>
                            <td>
                                <a class="edit-btn mx-1" style="text-decoration: none;"
                                    href="{{ route('Brand.Show', ['id' => $color->brand->id]) }}">
                                    {{ $color->brand->name }}
                                </a>
                            ...
                            <td>
                                <div style="display: flex;">
                                    ...
                                    <a class="btn btn-primary btn-sm edit-btn mx-1"
                                        href="{{ route('Color.Show', ['id' => $color->id]) }}">
